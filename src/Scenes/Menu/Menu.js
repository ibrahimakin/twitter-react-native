...
import { Text, View, Linking, SafeAreaView, ScrollView, TouchableOpacity } from 'react-native';
...
const Menu = (props) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={{ flex: 2, padding: 20, flexDirection: 'row', justifyContent: 'space-between', minHeight: 80, }} >
                <View>
                    {
                        props.profile_image ?
                            <TouchableOpacity
